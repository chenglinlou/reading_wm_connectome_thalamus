...
save("network_pre_nos.mat", 'm_K', 'k', "all_thres", "all_orin", "all_fix", "all_bin", "all_rand", "all_rnorm", "H", "P", "degree_nos", "allh","allnoh")
end